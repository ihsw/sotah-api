...
export const createModel = (sequelize: Sequelize): PricelistEntryModel => {
...
export const appendRelationships = (PricelistEntry: PricelistEntryModel, Pricelist: PricelistModel): PricelistEntryModel => {
